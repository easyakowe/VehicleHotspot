...
<div class="header-bottom">
	<div class="wrap">
		<div class="main-box">
			<div class="filter-wrapper ">
				<div class="category">
					...
					<ul id="filters" class="filter nav nav-pills">
						...
						<li class="active"><a href="trucks.php" data-count="8" data-filter=".services-category-2">Trucks</a></li>
			...
			<!-- The cars category -->
			<div>
			<p style="font-size: 19px; font-weight: bold;">Trucks</p>
			</div>
			<br>
			<div id="cars">
				<div class="gallery-grids">
		          		<div class="gallery-grid">
							<a href="images/eicher2.jpg"><img src="images/eicher2.jpg" alt=""></a>
							<h4>Eicher 2 Truck</h4>
						...
						<div class="gallery-grid grid2">
							<a href="images/chana.jpg"><img src="images/chana.jpg" alt=""></a>
							<h4>Chana Lightweight Truck</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
							<a href="images/BMC truck.jpg"><img src="images/BMC truck.jpg" alt=""></a>
							<h4>BMC Monster Truck</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="clear"> </div>
					 ...
					 <div class="gallery-grids">
						<div class="gallery-grid">
							<a href="images/eicher.jpg"><img src="images/eicher.jpg" alt=""></a>
							<h4>Eicher Heavyweight Truck</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid grid2">
							<a href="images/mitsubishi.jpg"><img src="images/mitsubishi.jpg" alt=""></a>
							<h4>Mitsubushi Fuso Truck</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
							<a href="images/bmc.jpg"><img src="images/bmc.jpg" alt=""></a>
							<h4>BMC Truck 2</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
