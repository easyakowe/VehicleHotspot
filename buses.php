...
<div class="header-bottom">
	<div class="wrap">
		<div class="main-box">
			<div class="filter-wrapper ">
				<div class="category">
					...
					<ul id="filters" class="filter nav nav-pills">
						...
						<li class="active"><a href="buses.php" data-count="5" data-filter=".services-category-3">Buses</a></li>
			...
			<!-- The cars category -->
			<div>
			<p style="font-size: 19px; font-weight: bold;">Buses</p>
			</div>
			<br>
			<div id="cars">
				<div class="gallery-grids">
						...
						<div class="gallery-grid grid2">
							<a href="images/fuso.jpg"><img src="images/fuso.jpg" alt=""></a>
							<h4>Mitsubishi Fuso</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
							<a href="images/hiace.jpg"><img src="images/hiace.jpg" alt=""></a>
							<h4>Toyota Hiace (Normal)</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="clear"> </div>
					 ...
					 <div class="gallery-grids">
						<div class="gallery-grid">
							<a href="images/setra.jpg"><img src="images/setra.jpg" alt=""></a>
							<h4>Mercedes Setra</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid grid2">
							<a href="images/marcopolo.jpg"><img src="images/marcopolo.jpg" alt=""></a>
							<h4>tata Marcopolo</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
