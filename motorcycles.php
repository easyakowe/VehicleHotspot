...
<div class="header-bottom">
	<div class="wrap">
		<div class="main-box">
			<div class="filter-wrapper ">
				<div class="category">
					...
					<ul id="filters" class="filter nav nav-pills">
						...
						<li class="active"><a href="motorcycles.php" data-count="5" data-filter=".services-category-4">Motorcycles</a></li>
			...
			<!-- The cars category -->
			<div>
			<p style="font-size: 19px; font-weight: bold;">Motorcycles</p>
			</div>
			<br>
			<div id="cars">
				<div class="gallery-grids">
		          		<div class="gallery-grid">
							<a href="images/honda.jpg"><img src="images/honda.jpg" alt=""></a>
							<h4>2017 Honda Superbike</h4>
						...
						<div class="gallery-grid grid2">
							<a href="images/ducati.jpg"><img src="images/ducati.jpg" alt=""></a>
							<h4>Ducati Panigale 1000cc</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
							<a href="images/kawasaki1.jpg"><img src="images/kawasaki1.jpg" alt=""></a>
							<h4>Kawasaki SuperRacer</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="clear"> </div>
					 ...
					 <div class="gallery-grids">
						...
						<div class="gallery-grid grid2">
							<a href="images/yamaha.jpg"><img src="images/yamaha.jpg" alt=""></a>
							<h4>Yamaha SuperBike</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="gallery-grid">
							<a href="images/tomahawk.jpg"><img src="images/tomahawk.jpg" alt=""></a>
							<h4>Dodge Tomahawk</h4>
							<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.</p>
							<p><a href="#" class="btn btn-primary">Read more</a></p>
						</div>
						<div class="clear"> </div>
